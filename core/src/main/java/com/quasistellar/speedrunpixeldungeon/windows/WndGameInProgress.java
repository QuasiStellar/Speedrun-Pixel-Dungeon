...
import com.quasistellar.speedrunpixeldungeon.scenes.StartScene;
	...
	public WndGameInProgress(final int slot){
		...
		Button debug = new Button(){
			...
			protected boolean onLongClick() {
				try {
					...
					SpeedrunPixelDungeon.scene().addToFront(new WndMessage("_Debug Info:_\n\n" +
		...
		RedButton cont = new RedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				SpeedrunPixelDungeon.switchScene(InterlevelScene.class);
			}
		};
		...
		RedButton erase = new RedButton( Messages.get(this, "erase")){
			...
			protected void onClick() {
				...
				SpeedrunPixelDungeon.scene().add(new WndOptions(Icons.get(Icons.WARNING),
