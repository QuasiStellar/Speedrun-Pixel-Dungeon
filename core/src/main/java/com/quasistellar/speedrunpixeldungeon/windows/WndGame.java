...
import com.quasistellar.speedrunpixeldungeon.scenes.RankingsScene;
...
public class WndGame extends Window {
	...
	public WndGame() {
		...
		RedButton curBtn;
		// Restart
		addButton( curBtn = new RedButton( Messages.get(this, "restart") ) {
			@Override
		...
		curBtn.icon(Icons.get(Icons.WAND));
		curBtn.textColor(Window.ORANGE);
