...
import com.quasistellar.speedrunpixeldungeon.sprites.FetidRatSprite;
import com.quasistellar.speedrunpixeldungeon.sprites.GnollTricksterSprite;
import com.quasistellar.speedrunpixeldungeon.sprites.GreatCrabSprite;
		...
		public RewardButton( Item item ){
			...
			slot = new ItemSlot( item ){
				...
				protected void onClick() {
					SpeedrunPixelDungeon.scene().addToFront(new RewardWindow(item));
				}
			};
			add(slot);
		}
