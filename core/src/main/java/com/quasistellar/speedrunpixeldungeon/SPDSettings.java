...
public class SPDSettings extends GameSettings {
	...
	public static void fullscreen( boolean value ) {
		...
		SpeedrunPixelDungeon.updateSystemUI();
	}
	...
	public static void landscape( boolean value ){
		...
		((SpeedrunPixelDungeon) SpeedrunPixelDungeon.instance).updateDisplaySize();
	}
	...
	public static final String KEY_BONES		= "bones";
	...
	public static void bones( boolean value ) {
		put( KEY_BONES, value );
	}

	public static boolean bones() {
		return getBoolean( KEY_BONES, false );
	}
