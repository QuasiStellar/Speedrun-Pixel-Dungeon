...
import com.quasistellar.speedrunpixeldungeon.actors.buffs.AdrenalineSurge;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.Amok;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.AnkhInvulnerability;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.Awareness;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.Barkskin;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.Berserk;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.Bless;
...
import com.quasistellar.speedrunpixeldungeon.actors.buffs.Combo;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.Drowsy;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.Foresight;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.HoldFast;
...
import com.quasistellar.speedrunpixeldungeon.actors.buffs.MindVision;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.Momentum;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.Paralysis;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.Regeneration;
import com.quasistellar.speedrunpixeldungeon.actors.buffs.SnipersMark;
...
import com.quasistellar.speedrunpixeldungeon.actors.mobs.Monk;
import com.quasistellar.speedrunpixeldungeon.actors.mobs.Snake;
import com.quasistellar.speedrunpixeldungeon.effects.CheckedCell;
...
import com.quasistellar.speedrunpixeldungeon.items.Dewdrop;
import com.quasistellar.speedrunpixeldungeon.items.EquipableItem;
import com.quasistellar.speedrunpixeldungeon.items.Heap;
import com.quasistellar.speedrunpixeldungeon.items.Heap.Type;
import com.quasistellar.speedrunpixeldungeon.items.Item;
import com.quasistellar.speedrunpixeldungeon.items.KindOfWeapon;
...
import com.quasistellar.speedrunpixeldungeon.items.armor.glyphs.Brimstone;
import com.quasistellar.speedrunpixeldungeon.items.armor.glyphs.Viscosity;
...
import com.quasistellar.speedrunpixeldungeon.items.bags.MagicalHolster;
import com.quasistellar.speedrunpixeldungeon.items.journal.Guidebook;
import com.quasistellar.speedrunpixeldungeon.items.keys.CrystalKey;
import com.quasistellar.speedrunpixeldungeon.items.keys.GoldenKey;
import com.quasistellar.speedrunpixeldungeon.items.keys.IronKey;
import com.quasistellar.speedrunpixeldungeon.items.keys.Key;
import com.quasistellar.speedrunpixeldungeon.items.keys.SkeletonKey;
...
import com.quasistellar.speedrunpixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.quasistellar.speedrunpixeldungeon.items.potions.exotic.PotionOfDivineInspiration;
...
import com.quasistellar.speedrunpixeldungeon.items.scrolls.exotic.ScrollOfChallenge;
...
import com.quasistellar.speedrunpixeldungeon.levels.features.Chasm;
import com.quasistellar.speedrunpixeldungeon.levels.traps.Trap;
import com.quasistellar.speedrunpixeldungeon.mechanics.ShadowCaster;
...
import com.quasistellar.speedrunpixeldungeon.scenes.SurfaceScene;
...
import com.quasistellar.speedrunpixeldungeon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			SpeedrunPixelDungeon.switchScene(AlchemyScene.class);
			return false;
