...
public enum Icons {
	...
	public static Image get( Icons type ) {
		...
		case CHALLENGE_OFF:
			...
			break;
		case BONES_ON:
			icon.frame( icon.texture.uvRect( 14, 128, 28, 139 ) );
			break;
		case BONES_OFF:
			icon.frame( icon.texture.uvRect( 0, 128, 14, 139 ) );
			break;
		case ARROW_RIGHT:
			icon.frame( icon.texture.uvRect( 28, 128, 41, 141 ) );
			break;
		case ARROW_LEFT:
			icon.frame( icon.texture.uvRect( 41, 128, 54, 141 ) );
			break;
		case PREFS:
		...
		case PLUS:
			...
			break;
		case WAND:
			icon.frame( icon.texture.uvRect( 80, 48, 94, 62 ) );
			break;
