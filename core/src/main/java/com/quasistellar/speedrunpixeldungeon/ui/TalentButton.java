...
import com.quasistellar.speedrunpixeldungeon.items.scrolls.exotic.ScrollOfMetamorphosis;
...
import com.quasistellar.speedrunpixeldungeon.windows.WndInfoTalent;
...
public class TalentButton extends Button {
	...
	protected void onClick() {
		...
		if (mode == Mode.UPGRADE
			...
			SpeedrunPixelDungeon.scene().addToFront(new WndInfoTalent(talent, pointsInTalent, new WndInfoTalent.TalentButtonCallback() {
			...
			SpeedrunPixelDungeon.scene().addToFront(new WndInfoTalent(talent, pointsInTalent, null));
		}
	}
