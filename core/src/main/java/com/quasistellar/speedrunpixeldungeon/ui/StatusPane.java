...
public class StatusPane extends Component {
	...
	private Image challengesMarker;
	private Image fullChallengesMarker;
	private Image bonesMarker;
	...
	protected void createChildren() {
		...
		if (Dungeon.challenges == Challenges.MAX_VALUE) {
			fullChallengesMarker = new Image(Icons.get(Icons.CHALLENGE_ON));
			add(fullChallengesMarker);
