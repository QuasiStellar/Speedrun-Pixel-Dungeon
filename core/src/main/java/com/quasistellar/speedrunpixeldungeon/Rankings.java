...
public enum Rankings {
	...
	public void submit( boolean win, Class cause ) {
		...
		rec.score	= score();
		rec.category= Dungeon.category;
		for (int i = 0; i < 26; i++) {
			rec.splits[i] = Timer.timeToString(Dungeon.splits[i]);
		}
...
//		}
	...
	public void saveGameData(Record rec){
		...
		rec.gameData.put( SPLITS, Dungeon.splits );
	}
	...
	public void loadGameData(Record rec){
		...
		Dungeon.splits = data.getLongArray(SPLITS);
	}
	...
	public static class Record implements Bundlable {
		...
		public String[] splits = new String[26];
		...
		public void restoreFromBundle( Bundle bundle ) {
			...
			splits = bundle.getStringArray( SPLITS );
