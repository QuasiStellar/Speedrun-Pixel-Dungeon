...
import com.quasistellar.speedrunpixeldungeon.items.weapon.missiles.darts.PoisonDart;
			...
			if (Dungeon.level.heroFOV[pos] || Dungeon.level.heroFOV[target.pos]) {
				Actor.add(new Actor() {
					...
					protected boolean act() {
						...
						((MissileSprite) SpeedrunPixelDungeon.scene().recycle(MissileSprite.class)).
