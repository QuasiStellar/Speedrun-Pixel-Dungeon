...
package com.quasistellar.speedrunpixeldungeon.items.weapon;
...
import com.quasistellar.speedrunpixeldungeon.actors.buffs.MagicImmune;
...
import com.quasistellar.speedrunpixeldungeon.items.weapon.curses.Annoying;
import com.quasistellar.speedrunpixeldungeon.items.weapon.curses.Displacing;
import com.quasistellar.speedrunpixeldungeon.items.weapon.curses.Exhausting;
import com.quasistellar.speedrunpixeldungeon.items.weapon.curses.Fragile;
import com.quasistellar.speedrunpixeldungeon.items.weapon.curses.Friendly;
import com.quasistellar.speedrunpixeldungeon.items.weapon.curses.Polarized;
import com.quasistellar.speedrunpixeldungeon.items.weapon.curses.Sacrificial;
import com.quasistellar.speedrunpixeldungeon.items.weapon.curses.Wayward;
...
import com.quasistellar.speedrunpixeldungeon.items.weapon.enchantments.Blooming;
import com.quasistellar.speedrunpixeldungeon.items.weapon.enchantments.Chilling;
import com.quasistellar.speedrunpixeldungeon.items.weapon.enchantments.Corrupting;
import com.quasistellar.speedrunpixeldungeon.items.weapon.enchantments.Elastic;
import com.quasistellar.speedrunpixeldungeon.items.weapon.enchantments.Grim;
import com.quasistellar.speedrunpixeldungeon.items.weapon.enchantments.Kinetic;
import com.quasistellar.speedrunpixeldungeon.items.weapon.enchantments.Lucky;
import com.quasistellar.speedrunpixeldungeon.items.weapon.enchantments.Projecting;
import com.quasistellar.speedrunpixeldungeon.items.weapon.enchantments.Shocking;
import com.quasistellar.speedrunpixeldungeon.items.weapon.enchantments.Unstable;
import com.quasistellar.speedrunpixeldungeon.items.weapon.enchantments.Vampiric;
