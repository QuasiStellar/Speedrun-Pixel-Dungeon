...
package com.quasistellar.speedrunpixeldungeon.desktop;
...
import com.quasistellar.speedrunpixeldungeon.services.news.NewsImpl;
import com.quasistellar.speedrunpixeldungeon.services.updates.UpdateImpl;
	...
	public static void main (String[] args) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				exceptionMsg = exceptionMsg.replace("com.quasistellar.speedrunpixeldungeon.", "");
				...
				if (exceptionMsg.contains("Couldn't create window")){
					TinyFileDialogs.tinyfd_messageBox(title + " Has Crashed!",
							title + " wasn't able to initialize it's graphics display, sorry about that!\n\n" +
									...
									"If you're certain the game should be working on your computer, feel free to message the developer (quasistellar.official@gmail.com)\n\n" +
		...
		if (SharedLibraryLoader.isWindows) {
			if (System.getProperties().getProperty("os.name").equals("Windows XP")) {
				basePath = "Application Data/.quasistellar/Speedrun Pixel Dungeon/";
			} else {
				basePath = "AppData/Roaming/.quasistellar/Speedrun Pixel Dungeon/";
			}
		} else if (SharedLibraryLoader.isMac) {
			basePath = "Library/Application Support/Speedrun Pixel Dungeon/";
		} else if (SharedLibraryLoader.isLinux) {
			basePath = ".quasistellar/speedrun-pixel-dungeon/";
		}
		...
		new Lwjgl3Application(new SpeedrunPixelDungeon(new DesktopPlatformSupport()), config);
	}
}
